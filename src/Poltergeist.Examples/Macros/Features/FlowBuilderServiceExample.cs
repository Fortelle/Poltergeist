...
[ExampleMacro]
public class FlowBuilderServiceExample : CommonOneshotMacroBase
{
    ...
    {
        var flow1 = controller.Processor.GetService<FlowBuilderService>();
        ...
        var flow2 = controller.Processor.GetService<FlowBuilderService>();
        ...
        var flow3 = controller.Processor.GetService<FlowBuilderService>();
